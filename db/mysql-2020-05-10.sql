...
) ENGINE = InnoDB COMMENT = 'CMS文章中心';

-- ----------------------------
-- Records of article
-- ----------------------------
BEGIN;
INSERT INTO `article` VALUES (1, 5, '文章示例：忘记账号密码怎么办？', '忘记账号密码后，可以通过APP验证信息后完成密码重置。', 'c_3.7.1,账号,密码', '<p>在APP“业务办理”中选择“密码重置”，验证必要的个人信息后，完成密码更新操作。同时，您也可以官网的登录窗口，选择“忘记密码”进行密码更新。</p>', '交易相关', '账户密码', '2019-12-12 15:56:00', '2020-04-29 21:11:12', 118, '', NULL);
COMMIT;
...
) ENGINE = InnoDB COMMENT = '自动回复规则';

-- ----------------------------
-- Records of msg_reply_rule
-- ----------------------------
BEGIN;
INSERT INTO `msg_reply_rule` VALUES (1, '关注公众号', 'subscribe', 1, 'text', '你好，欢迎关注！\n<a href=\"https://github.com/niefy\">点击链接查看我的主页</a>', 1, '关注回复', '00:00:00', '23:59:59'), (9, '人工-9点前', '人工,客服', 0, 'text', '您好，人工在线时间为工作日9:00-17:30。现在是非人工时段，您的咨询，我们将于下一工作日回复。', 1, '人工客服', '00:00:00', '09:00:00'), (10, '人工-五点半后', '人工,客服', 0, 'text', '您好，人工在线时间为工作日9:00-17:30。现在是非人工时段，您的咨询，我们将于下一工作日回复。', 1, '人工客服', '17:30:00', '23:59:59'), (11, '人工-工作时间', '人工', 0, 'text', '人工在线时间为工作日9:00-17:30。如您于工作时间咨询，我们将于工作时间内回复您！', 1, '人工客服', '09:00:00', '17:30:00');
COMMIT;
...
) ENGINE = InnoDB COMMENT = '微信模版消息发送记录';
...
CREATE TABLE `wx_qr_code`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB COMMENT = '公众号带参二维码';
