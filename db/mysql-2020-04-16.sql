...
-- Records of article
-- ----------------------------
INSERT INTO `article` VALUES (1, 5, '文章示例：忘记账号密码怎么办？', '忘记账号密码后，可以通过APP验证信息后完成密码重置。', 'c_3.7.1,账号,密码', '<p>在APP“业务办理”中选择“密码重置”，验证必要的个人信息后，完成密码更新操作。同时，您也可以官网的登录窗口，选择“忘记密码”进行密码更新。</p>', '交易相关', '账户密码', '2019-12-12 15:56:09', '2019-12-12 15:56:09', 118, '', NULL);
...
CREATE TABLE `msg_news`  (
  ...
  `title` varchar(20) NOT NULL COMMENT '图文消息的标题',
  `description` varchar(200) NULL DEFAULT NULL COMMENT '消息的内容：对于文本类型，content是文本内容，对于图文、图片、语音、视频类型，content是mediaID',
  `pic_url` varchar(200) NULL DEFAULT NULL COMMENT '摘要',
  `url` varchar(500) NULL DEFAULT NULL COMMENT '作者',
